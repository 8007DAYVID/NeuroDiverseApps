...
/*
 * Read in a file that uses tab seperation.
 * Have the user specifiy the input file name and the output file name.
 * Write each individual value out to a different file, with one value per line.
 * Also keep a total and write the total as the last line of the output file.
 */
